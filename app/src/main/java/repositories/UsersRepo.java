...
public class UsersRepo {
    ...
    public User getObjektua(String user) {
        return userDAO.getObjektua(user);
    }
    ...
    public String getEmailLogin(String user) {
        return userDAO.getEmailLogin(user);
    }

    public int getIdUser(String user) {
        return userDAO.idLortu(user);
    }
